...
public class RequestHandler {
    ...
    //First argument is the URL of the script to which the request is sent
    //Other is an HashMap with name value pairs containing the data to be sent with the request
